...
struct LinearExample: View {
    ...
    var body: some View {
        HeartIcon()
            .stroke(style: StrokeStyle(lineWidth: 4, lineCap: .round, dash: [10], dashPhase: moving ? -100 : 0))
            ...
            .animation(.linear(duration: 2).repeatForever(autoreverses: false), value: moving)
            .onAppear {
                moving = true
            }
    }
